...
public class Ajouter_episodeController implements Initializable {
    ...
    @FXML
    private ComboBox<String> comb_init;
    ...
    public void initialize(URL url, ResourceBundle rb) {
     ...
     for(Season ss:sea){
         ...
         int id =ss.getId();
         String comboval=id+" : "+ss.getName();
         comb_init.getItems().add(comboval);
    ...
    private void comb_fin(ActionEvent event) {
        comb_init.getSelectionModel().selectedItemProperty().addListener(new ChangeListener<String>(){
            @Override
            public void changed(ObservableValue<? extends String> ov, String t, String t1) {
                //throw new UnsupportedOperationException("Not supported yet.");
                //To change body of generated methods, choose Tools | Templates.
                String seasonidname = comb_init.getSelectionModel().getSelectedItem();
                String seasonid= (seasonidname.substring(0,seasonidname.indexOf(":") )).trim();
                
                season_id =Integer.parseInt(seasonid);
